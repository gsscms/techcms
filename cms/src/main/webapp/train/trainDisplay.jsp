  ...
  <script>
	...
	$(function() {
		    ...
		    jQuery("#moduleList").jqGrid({
		   	url:'<%= path%>/dictAction!initTrainTypeDict',
			datatype: "json",
			...
			colModel: [
			           ...
			           {name: "value",index:"value",width:20,hidden:false, key:true,resizable: false,align:"center"}//,
			          
// 			        {
// 			               name: "id",index:"id",width:10,hidden:false, key:true,resizable: false,align:"center",
// 			               formatter:function(cellvalue, options, rowdata){
			        	   
// 			        	   return "<a href='#' style='color:#0072bc; text-decoration : underline' onclick=displaySkill('"+rowdata.id+"')>【选择交流培训】</a>"; 
// 			               }
// 			           }
