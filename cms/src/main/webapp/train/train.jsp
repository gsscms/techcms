  ...
  <script src="<%=path %>/jquery-ui-1.10.4.custom/js/jquery-ui-1.10.4.custom.js"></script>
	...
	function forSave(){
	    if($("#select").find("option:selected").val()==""){
		    ...
		    document.forms[0].action="<%=path%>/trainGridAction!saveTrain";
...
<table width="100%">
	...
	<tr>
		<td>
			<textarea cols="80" id="editor1"  rows="10"><s:property value="info.content" /></textarea>
		</td>
	</tr>
</table>
